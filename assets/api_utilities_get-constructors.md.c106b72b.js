import{_ as s,c as n,o as a,a as t}from"./app.0827ef81.js";const g=JSON.parse('{"title":".utils.getConstructors(argument)","description":"","frontmatter":{},"headers":[],"relativePath":"api/utilities/get-constructors.md","lastUpdated":1673749473000}'),e={name:"api/utilities/get-constructors.md"},o=t(`<h1 id="utils-getconstructors-argument" tabindex="-1">.utils.getConstructors(argument) <a class="header-anchor" href="#utils-getconstructors-argument" aria-hidden="true">#</a></h1><p>Returns an <strong>array of constructors</strong> by the object prototype hierarchy. See <a href="./../types/constructor">Constructor[]</a> type.</p><p>Usage example:</p><div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#82AAFF;">getConstructors</span><span style="color:#A6ACCD;">(</span><span style="color:#89DDFF;">null</span><span style="color:#A6ACCD;">)</span></span>
